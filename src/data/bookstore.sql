...
-- Dumping data for table bookstore.books: ~15 rows (approximately)
DELETE FROM `books`;
...
INSERT INTO `book_images` (`id`, `created_at`, `updated_at`, `url`, `book_id`) VALUES
	...
	('70240b93-c92f-4d5c-97e3-ca5418a8463a', '2025-02-26 15:13:49.262367', '2025-02-26 15:13:49.262416', 'https://res.cloudinary.com/dimer1lki/image/upload/v1740582584/image_230105_ohp8b5.jpg', 'c40193ab-557d-4cc1-9999-a7876dc34fbd'),
...
-- Dumping data for table bookstore.reviews: ~4 rows (approximately)
DELETE FROM `reviews`;
...
INSERT INTO `users` (`id`, `created_at`, `updated_at`, `avatar`, `email`, `name`, `password`, `status`, `username`) VALUES
	...
	('9b1c2041-348d-4cb4-98e5-bbf229c4a17f', '2024-11-25 14:23:09.381710', '2025-02-26 15:24:30.263284', 'https://ui-avatars.com/api/?background=random&rounded=true&bold=true&name=Anh+Tuan', 'atuandev@gmail.com', 'Nguyen Phan Anh Tuan', '$2a$10$HORkkzUpfW5X4Lw7/HlP5umSRGBQyEI7WSaBejIEINmB7im/kcT12', 'ACTIVE', 'admin');
...
-- Dumping data for table bookstore.users_roles: ~3 rows (approximately)
